...
| R04 | public-api-surface-enforcement | pattern | different | DIVERGENT | — | [prompt](topics/04-public-api-surface-enforcement/prompts/public-api-surface-enforcement.prompt.md) | resolved |
...
| R23 | lockfile-version-sync | pattern | different | DIVERGENT | — | [prompt](topics/23-lockfile-version-sync/prompts/lockfile-version-sync.prompt.md) | resolved |
...
| R47 | contributors-recipe-mode | pattern | different | DIVERGENT | — | [prompt](topics/47-contributors-recipe-mode/prompts/contributors-recipe-mode.prompt.md) | resolved |
